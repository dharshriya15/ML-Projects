...
Revision ID: 160faedba8e0
Revises: 
Create Date: 2024-05-30 11:27:23.341150
...
def upgrade():
    ...
    with op.batch_alter_table('book', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_book_published_date'), ['published_date'], unique=False)
...
def downgrade():
    ...
    op.drop_table('user')
    with op.batch_alter_table('book', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_book_published_date'))
